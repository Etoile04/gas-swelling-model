...
if __name__ == '__main__':
    ...
    # Test parameters
    T_test = 600  # K
    Evf_coeffs_test = [1.034, 7.6e-4]
    Eif_coeffs_test = [-3.992, 0.038, -7.645e-5, 5.213e-8]
    kB_ev_test = 8.617e-5  # eV/K
    ...
    print(f"  玻尔兹曼常数 kB = {kB_ev_test} eV/K")

    # Test vacancy concentration
    print(f"\n空位浓度测试 (Vacancy Concentration Test):")
    cv0 = calculate_cv0(T_test, Evf_coeffs_test, kB_ev_test)
    print(f"  cv0 = {cv0:.6e}")

    # Test interstitial concentration
